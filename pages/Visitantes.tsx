      ...
      <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
        <CardContent className="p-6">
          <div className="flex flex-col space-y-4">
            ...
            {/* Linha de baixo com Filtros e Abas */}
            <div className="flex flex-col lg:flex-row gap-4 justify-between items-center">
              <Tabs value={statusFilter} onValueChange={setStatusFilter} className="w-full lg:w-auto">
                <TabsList className="bg-slate-100 w-full lg:w-auto">
                  ...
                  <TabsTrigger value="no_condominio" className="flex-1 lg:flex-none">No Condomínio</TabsTrigger>
                  <TabsTrigger value="saiu" className="flex-1 lg:flex-none">Saíram</TabsTrigger>
                </TabsList>
              </Tabs>
